...
class ConfigStore{
    ...
    constructor(configDir, cliRoot){
        ...
        // create contextual require paths, incl project dir (if defined) as first priority; include configDir
        // for Windows execution as XDG config is the same as sf / sfdx runtime 
        this.requirePaths = [this.cliRoot, configDir];
